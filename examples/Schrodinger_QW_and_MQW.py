...
# test_structure = Structure([top_layer, inter, well_layer, inter, bottom_layer], substrate = bulk)

# 10 QWs without interlayers
test_structure = Structure([top_layer, barrier_layer] + 10 * [well_layer, barrier_layer] + [bottom_layer],
                           substrate=bulk)

# Finally, the quantum properties are calculated here
output = QM.schrodinger(test_structure, quasiconfined=0.05, graphtype='potentialsLDOS', num_eigenvalues=200, show=True)
