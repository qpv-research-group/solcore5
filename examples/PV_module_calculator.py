...
db_junction2 = Junction(
    kind="2D", T=T, reff=1, jref=300, Eg=1.4, A=1, R_series=0.00012, R_shunt=1e14, n=3.5
)
db_junction3 = Junction(
    kind="2D", T=T, reff=1, jref=300, Eg=1.9, A=1, R_series=8.0e-5, R_shunt=1e14, n=3.5
)

my_solar_cell = SolarCell(
    [db_junction3, db_junction2, db_junction], T=T, R_series=0.0, area=0.1
)
...
voltage, current, all_Isc_values, raw_data = solve_pv_module(
    my_solar_cell, options, jscSigma=0.02
)
