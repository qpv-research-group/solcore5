...
Please, visit `Solcore's Documentation <http://solcore5.readthedocs.io>`__, the :doc:`Tutorial <docs/source/Examples/tutorial>` for a step-by-step example of how to use *Solcore* to model a solar cell and also check the :doc:`Examples folder <examples>` for more specific information and examples of usage.
