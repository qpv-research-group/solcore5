...
def remove_source(section: str, name: str) -> None:
    """General function to remove sources from the configuration files. It checks if the
    source exists and, if so, if it is a default Solcore source. In the later case, it
    disable the source by setting it to an empty string rather than removing it.

    :param section: The section to remove a source from. :param name: The name of the
    source. :return: None
    """
...
def add_source(section: str, name: str, location: str) -> None:
    """General function to add sources to the configuration files. If the source already
    exists, its value will be replaced by the new one.

    :param section: The section to add a source to. :param name: The name of the source.
    :return: None
    """
...
def restore_default_source(section: str, name: str) -> None:
    ...
    :param section: The section of the source. :param name: The name of the source.
    :return: None
    """
...
def add_units_source(name: str, location: str) -> None:
    ...
    :param name: The name of the source. :param location: The full path to the location
    of the source. The source must be a ConfigParser formatted file. :return: None
    """
...
def add_materials_source(name: str, location: str) -> None:
    ...
    :param name: The name of the source. :param location: The full path to the location
    of the source. The source must be a folder containing the n and k data of the
    material. See the the Material System in the manual for more information. :return:
    None
    """
...
def remove_units_source(name: str) -> None:
    ...
    :param name: The name of the source. :return: None
    """
...
def welcome_message(show: bool) -> None:
    ...
    :param show: True/False for showing/hiding the welcome message :return: None
    """
...
def verbose_loading(show: bool) -> None:
    ...
    :param show: True/False for showing/hiding the loading messages :return: None
    """
...
def set_location_of_spice(location: str) -> None:
    ...
    :param location: The location of the spice executable. :return: None
    """
...
def set_location_of_smarts(location: str) -> None:
    """Sets the location of the SMARTS distribution (the root folder). It does not test
    if it works.

    :param location: The location of the SMARTS distribution. :return: None
    """
