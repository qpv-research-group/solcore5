# Using the Custom_CPPB Model module.
# Example 1 -- Reading in material parameters and using the Mod_CPPB function to approximate the complex dielectric
# function of GaAs.
...
# from Oeilvert.Graphing.Custom_Colours import colours
# Note: Matplotlib.pyplot and numpy are loaded automatically with solcore so no need for separate import statements...
import matplotlib.pyplot as plt
import csv
import numpy as np

# First, read in experimental data for GaAs dielectric function (Palik)...
