...
def iv_multijunction(solar_cell, options):
    ...
    In the end, the soalr_cell object is updated with an "iv" attribute containing a dictionary with:
        ...
        "V": Device voltages
        "I": Device currents (the same for all junctions).
        "Isc", Voc", "P" and "FF": In case of mpp = True.
    ...
    :param kwargs: A dictionary containing, at least, the following elements:
        ...
        - tol_MJ: Tolerance for the solver of the node equations
    :return: None
...
# def calculate_J02_from_J01_Jsc_rad_eff(Jsc, J01, radiative_efficiency):
#     J02 = np.sqrt(2 * J01 * Jsc * (radiative_efficiency - 1))
#
#     return J02
#
#
